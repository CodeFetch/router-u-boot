...
#define QCA_DDR_TAP_CTRL_1_REG			QCA_DDR_CTRL_BASE_REG + 0x020
...
#if (SOC_TYPE & QCA_AR724X_SOC) |\
    (SOC_TYPE & QCA_AR933X_SOC)
	...
	#if (SOC_TYPE & QCA_AR724X_SOC)
		#define QCA_DDR_WB_FLUSH_PCIE_REG	QCA_DDR_CTRL_BASE_REG + 0x088
	#endif
...
#if (SOC_TYPE & QCA_AR724X_SOC)
	#define QCA_DDR_MR_VALUE_MASK	BITS(QCA_DDR_MR_VALUE_SHIFT, 13)
#else
...
#if (SOC_TYPE & QCA_AR724X_SOC)
	#define QCA_DDR_EMR_VALUE_MASK	BITS(QCA_DDR_EMR_VALUE_SHIFT, 13)
#else
...
/* TAP_CONTROL_X registers (DQS delay tap control for byte X) */
	...
	#if (SOC_TYPE & QCA_AR724X_SOC)
		#define QCA_DDR_TAP_CTRL_TAP_BYPASS_SHIFT	6
		#define QCA_DDR_TAP_CTRL_TAP_BYPASS_MASK	BIT(QCA_DDR_TAP_CTRL_TAP_BYPASS_SHIFT)
	#endif
#endif
...
/* JTAG GPIO pin mask */
#if (SOC_TYPE & QCA_AR724X_SOC)
	/* Note: uses TCK pin for JTAG clock */
...
#define QCA_GPIO_INT_MASK_REG		QCA_GPIO_BASE_REG + 0x24
	...
	#define QCA_GPIO_IN_ETH_SW_LED_REG		QCA_GPIO_BASE_REG + 0x2C
...
/*
 * GPIO (read-only) input values
 */
#define QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT0_SHIFT		0
#define QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT0_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT0_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT1_SHIFT		1
#define QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT1_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT1_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT2_SHIFT		2
#define QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT2_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT2_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT3_SHIFT		3
#define QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT3_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT3_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT4_SHIFT		4
#define QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT4_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_ACTV_PORT4_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_COLL_PORT0_SHIFT		5
#define QCA_GPIO_IN_ETH_SW_LED_COLL_PORT0_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_COLL_PORT0_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_COLL_PORT1_SHIFT		6
#define QCA_GPIO_IN_ETH_SW_LED_COLL_PORT1_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_COLL_PORT1_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_COLL_PORT2_SHIFT		7
#define QCA_GPIO_IN_ETH_SW_LED_COLL_PORT2_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_COLL_PORT2_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_COLL_PORT3_SHIFT		8
#define QCA_GPIO_IN_ETH_SW_LED_COLL_PORT3_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_COLL_PORT3_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_COLL_PORT4_SHIFT		9
#define QCA_GPIO_IN_ETH_SW_LED_COLL_PORT4_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_COLL_PORT4_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT0_SHIFT		10
#define QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT0_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT0_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT1_SHIFT		11
#define QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT1_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT1_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT2_SHIFT		12
#define QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT2_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT2_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT3_SHIFT		13
#define QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT3_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT3_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT4_SHIFT		14
#define QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT4_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_DUPL_PORT4_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_LINK_PORT0_SHIFT		15
#define QCA_GPIO_IN_ETH_SW_LED_LINK_PORT0_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_LINK_PORT0_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_LINK_PORT1_SHIFT		16
#define QCA_GPIO_IN_ETH_SW_LED_LINK_PORT1_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_LINK_PORT1_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_LINK_PORT2_SHIFT		17
#define QCA_GPIO_IN_ETH_SW_LED_LINK_PORT2_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_LINK_PORT2_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_LINK_PORT3_SHIFT		18
#define QCA_GPIO_IN_ETH_SW_LED_LINK_PORT3_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_LINK_PORT3_SHIFT)
#define QCA_GPIO_IN_ETH_SW_LED_LINK_PORT4_SHIFT		19
#define QCA_GPIO_IN_ETH_SW_LED_LINK_PORT4_MASK		BIT(QCA_GPIO_IN_ETH_SW_LED_LINK_PORT4_SHIFT)
...
#define QCA_PLL_CPU_PLL_CFG_REG		QCA_PLL_BASE_REG + 0x00
	...
	#else
		#if (SOC_TYPE & QCA_AR724X_SOC)
			#define QCA_PLL_ETH_USB_PLL_CFG_REG			QCA_PLL_BASE_REG + 0x04
			#define QCA_PLL_CPU_CLK_CTRL_REG			QCA_PLL_BASE_REG + 0x08
		#else
